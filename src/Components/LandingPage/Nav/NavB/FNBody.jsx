...
const FNBody = () => {
  return (
    <section className=" bg-cover bg- flex justify-center mt-8 w-screen xl:px-3 2xl:px-16 xl:w-[75rem] 2xl:w-11/12 my-32 exsm:my-48 lg:my-0 msm:mb-72 lg:mb-96 z-50 relative ">
      ...
      >
        <div
          className="  flex flex-col items-start pl-4 pr-2 child:py-3 esm:items-center  esm:flex-row justify-between child:object-contain child:w-32 sm:child:w-52 sm:child:px-3  
        ...
        <div
          className=" flex-col flex items-start px-4 child:py-3 esm:child:px-5 esm:child:w-44 w-full  esm:justify-center esm:items-center esm:flex-row justify-evenly child:w-28 sm:child:mx-10 msm:child:px-5 
