  ...
  return (
    <section className=" rounded-2xl 11/12 msm:w-10/12 text-white mt-72 h-full relative ">
      ...
      <div className=" relative flex flex-col items-center">
        <h2 className="bg-gradient-to-r  pt-20 z-20 mb-20 relative from-[#69EACB] via-[#EACCF8] to-[#6654F1] inline-block font-headerFont font-semibold text-transparent bg-clip-text text-lg extsm:text-2xl exsm:text-3xl sm:text-2xl imd:text-5xl  llgg:text-6xl">
          Articles
        </h2>
