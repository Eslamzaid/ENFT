  ...
  return (
    <section className=" rounded-3xl 11/12 msm:w-10/12 text-white mt-72 h-full">
      <div className=" relative flex flex-col items-center">
        <div className=" border-slate-700 border rounded-3xl  shadow-2xl absolute h-full z-10 w-10/12"></div>
        ...
        <aside className=" pb-10 z-20  flex flex-wrap font-poppi justify-center sty:justify-between w-9/12 child:flex child:flex-col child:items-center child:justify-baseline child:mx-4">
          <div className="exsm:[&>p]:w-72 [&>p]:w-56 exsm:[&>h3]:text-xl [&>h3]:text-md [&>h3]:font-semibold [&>h3]:my-5 text-center flex-none">
          ...
          <div className="exsm:[&>p]:w-72 [&>p]:w-56 exsm:[&>h3]:text-xl [&>h3]:text-md [&>h3]:font-semibold [&>h3]:my-5 text-center sty:flex-grow remo:flex-none">
